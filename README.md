...
https://github.com/ocassionallynotsuperpro
...
- You can also directly proceed by using the live server [demo link](.......)
...
1. Clone the Repository: Open a terminal or command prompt and clone the I-Love-You repository from GitHub using the following command:
  ...
  ```bash
    git clone https://github.com/ocassionallynotsuperpro
  ```
...
2. `Clone` your fork to your local machine. 
    Use the command `git clone https://github.com/ocassionallynotsuperpro`.
...
<img  src="Pages/Assets/" alt="Author">


### :email: Contact 
- Email and social media links.
- Head over to my github handle form [here](https://github.com/ocassionallynotsuperpro)
...
<p align="left">
<a href="https://github.com/ocassionallynotsuperpro" target="blank"><img src="https://github.com/ocassionallynotsuperpro" alt="rohan-sharma=9386" /></a>
</p>

<p align="center">
    People who <a href="https://github.com/ocassionallynotsuperpro">STARRED</a> this repo
</p>

<p align="right">Note: The site is not responsive yet, but it will be responsive soon.</p>

<p align="right" >
    <img height="40px" width="40px" src="Pages/Assets\" />
</p>
